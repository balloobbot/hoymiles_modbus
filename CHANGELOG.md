...
* requires modbus-connection 4.6.1 or newer. Its `connect_delay`, `message_spacing` and `disconnect()` are worth reaching for with an unreliable DTU - see the usage documentation
